        ...
        <div name="home" className='w-full h-screen bg-[#000C66]'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <div className='text-4xl sm:text-7xl font-bold text-[#8892b0] flex'>
                    <h2>I am a </h2>
                    <h2 className='ml-4 border-b-4 border-pink-600'>{<Typewriter options={{ strings: ['Data Analyst.', 'Mech. Engineer.', 'Patent Engineer.', 'QA Engineer.', 'SQL Analyst.', 'Apex Legend.', 'Dog Leader.', 'Degenerate.'], autoStart: true, loop: true }} />}</h2>
                </div>
